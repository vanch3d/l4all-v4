...
<div id="outer-column-container">
	...
	<form class="tableless" name="My_Details" action="registerUser" method="post">
	<fieldset>
		...
		<div class="required">
			...
			<input name="redirect" value="/admin/register.jsp" type="hidden">
		...
		<fieldset>
			...
			<label for="status_0" class="labelRadio">
				<input name="status" id="status_0" class="inputRadio" value="user" type="radio">
			 	User
			</label>
			<label for="status_1" class="labelCheckbox">
				<input name="status" id="status_1" class="inputRadio" value="expert" type="radio">
				Expert
			</label>
			<label for="status_2" class="labelCheckbox">
				<input name="status" id="status_2" class="inputRadio" value="template" type="radio">
				Recommendation
			</label>
		</fieldset>
		</div>
