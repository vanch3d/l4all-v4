...
Timeline.DefaultEventSource.prototype.loadXML = function(xml, url) {
    ...
    var desc = xml.documentElement.getAttribute("description");
    ...
    while (node != null) {
        if (node.nodeType == 1) {
            ...
            var evt = new Timeline.DefaultEventSource.Event(
                ...
                node.getAttribute("isEditable") == "true",
...
Timeline.DefaultEventSource.Event = function(
		position,
        start, end, latestStart, earliestEnd, instant, editable,
